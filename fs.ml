...
type conf = (((values * values), (string * (expr) StateVars.t * values)) Hashtbl.t *
...
let rec eval_expr
  ...
  match e with
    ...
    | This None -> (blockchain, sigma, Hashtbl.find vars "this")
    | This (Some s) -> (blockchain, sigma, Val(VAddress("0x23213")))
